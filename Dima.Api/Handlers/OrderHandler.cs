...
public class OrderHandler(AppDbContext context) : IOrderHandler
{
    public async Task<Response<Order?>> CancelAsync(CancelOrderRequest request)
    {
        ...
        switch (order.Status)
        {
            ...
            case EOrderStatus.Refunded:
                return new Response<Order?>(order, 400, "Esse pedido já foi reembolsado e não pode ser cancelado");
            default:
                return new Response<Order?>(order, 400, "Esse pedido não pode cancelado");
        }
        ...
        try
        {
            if (request.VoucherId is not null)
            {
                ...
                if (voucher.IsActive == false)
                    return new Response<Order?>(null, 400, "Voucher já utilizado");
    ...
    public async Task<Response<Order?>> PayAsync(PayOrderRequest request)
    {
        ...
        switch (order.Status)
        {
            ...
            default:
                return new Response<Order?>(order, 400, "Não foi possivel pagar o pedido");
        }
    ...
    public async Task<Response<Order?>> RefundAsync(RefundOrderRequest request)
    {
        ...
        switch (order.Status)
        {
            ...
            default:
                return new Response<Order?>(order, 400, "Não foi possivel reembolsar o pedido");
        }
